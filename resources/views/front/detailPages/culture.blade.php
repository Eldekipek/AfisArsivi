                        ...
                        <div class="modal-body">
                            ...
                            <div class="mt-3" style="    display: flex;
                                        ...
                                        <span class="common-links">
                                            ...
                                            <h2 class="title"><strong> <!--Proje adı--->
                                                <span><a href="" class="">{{($culture->title)}}</a></span></strong>
                                            </h2><!---->
                                            <h1 class="title"> {{($culture->date)}}</h1> <!--Tarih--->
                                            <small class="caption lining-numbers">{{($culture->country)}} |</small>
                                            <!--Kullanıldığı yer-->
                                            <small
                                                class="caption lining-numbers">{{($culture->printing_technique)}},</small>
                                            <!--Baskı tekniği-->
                                            <small class="caption lining-numbers">{{($culture->dimensions)}}</small>
                                            <!--ebat-->
                                        </span>
