...
@section("content")
    ...
    font-weight: 400;
    font-style: normal;">Tipografik Afişler Arşivi</h2>
        </div>
        <div class="social-poster-title ">
            <strong><p> {{$tipografi_poster->count()}} Afiş</p></strong>
        </div>
    </div>
                ...
                @foreach($tipografi_poster as $tipografi)
                    <div href="" class="poster-items- w-imgs">
                        <div class="poster-card-top">
                            <picture>
                                <img
                                    src="{{asset('uploads/thumbnail/'.$tipografi->image)}}"
                                    alt="">
                            </picture>
                        </div>
...
<small class="caption lining-numbers">{{($tipografi->printing_technique)}},</small>
                    ...
                    <small class="caption lining-numbers">{{($tipografi->dimensions)}}</small><!--ebat-->
                            ...
                            <div class="afis-detail">
                                ...
                                <button type="button" class="btn btn- border" onclick="getPoster({{$tipografi->id}})"  data-toggle="modal"
