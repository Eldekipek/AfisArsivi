...
@section("content")
    ...
    align-items: center;">
                <div class="profile-img">
                    <div>
                        <picture>
                            <img src="{{asset('https://images.typographicposters.com/icon-2x-p3/_profile/manuel-kreuzer/5ffd9c7e106b1ff883382d00.jpg')}}" alt="">
                        </picture>
                    </div>
                </div>
                <div class="profile-name">
                    <h2>Manuel Kreuzer</h2>
                </div>
                <div class="profile-birth">
                    <h6>1994-</h6> <h6> Germany</h6>
                </div>
             </div>
            <div class="summary">
                <p>i founded my studio for graphic an communication design in 2004 in passau, germany. i develop solutions for clients from the cultural, public and commercial sector. the focus of my work is on clear – sometimes unclear – and unused typography.i founded my studio for graphic an communication design in 2004 in passau, germany. i develop solutions for clients from the cultural, public and commercial sector. the focus of my work is on clear – sometimes unclear – and unused typography.</p>
            </div>
        </div>
    </div>
