        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse @if(Request::segment(2)=='posterler') show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item @if(Request::segment(2)=='posterler' and !Request::segment(3)) active @endif" href="#">Tüm Posterler</a>
                    <a class="collapse-item @if(Request::segment(2)=='posterler' and Request::segment(3)=='create') active @endif"  href="{{route("poster.create")}}">Poster Oluştur</a>
                </div>
            </div>
        </li>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 ">Fatih Ozveren</span>
                        </a>
